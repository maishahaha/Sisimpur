...
def send_document_processing_success_webhook(user, job, questions_count):
    """
    Send a webhook for successful document processing.
    ...
    return send_webhook("document_processing_success", payload)


def send_document_processing_failed_webhook(user, job, error_message):
    """
    Send a webhook for failed document processing.
    ...
    return send_webhook("document_processing_failed", payload)


def send_normal_signin_webhook(user):
    """
    Send a webhook for normal email/password sign in.
    ...
    return send_webhook("normal_signin", payload)
