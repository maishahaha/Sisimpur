    ...
    def process(self, file_path: str, max_questions: Optional[int] = None) -> list:
        ...
        try:
            ...
            try:
                ...
                response = api.generate_content([prompt, pdf_data], model_name=DEFAULT_GEMINI_MODEL)
                ...
                response = api.generate_content([prompt, pdf_data], model_name=FALLBACK_GEMINI_MODEL)
