...
def main():
    ...
    parser.add_argument("--text", "-x", type=str, help="Raw passage text input to generate Q&A from")
    ...
    try:
        if args.text:
            ...
            output_file = generate_qa_from_raw_text(
                ...
                source_name=args.source_name if hasattr(args, "source_name") else None
           )
